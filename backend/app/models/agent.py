...
class Agent(Base):
    ...
    input_tokens_today: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    input_tokens_month: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    input_tokens_total: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
