...
export default function SkillsTab(props: Props) {
    ...
    return (
        <div>
            ...
            <FileBrowser api={adapter} rootPath="skills" features={{ newFile: canManage, edit: canManage, delete: canManage, newFolder: canManage, upload: canManage, directoryNavigation: true }} title={t('agent.skills.skillFiles')} showFrontmatter />
